Public Class Test_1_PP
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If RadioButton9.Checked Then
            ...
            zbir = zbir + 1
        ElseIf RadioButton7.Checked Or RadioButton8.Checked Then
    ...
    Private Sub Test_1_PP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Form3.Hide()
    End Sub
End Class