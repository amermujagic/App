Public Class Test_2_TT
    ...
    Private Sub Test_2_TT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Form2.Hide()
    ...
    Private Sub Button30_Click(sender As Object, e As EventArgs) Handles Button30.Click
        ...
        If RadioButton8.Checked Then
            ...
            zbir = zbir + 1
        ElseIf RadioButton9.Checked Or RadioButton7.Checked Then
        ...
        If RadioButton10.Checked Then
            ...
            zbir = zbir + 1
        ElseIf RadioButton11.Checked Or RadioButton12.Checked Then
        ...
        If RadioButton14.Checked Then
            ...
            zbir = zbir + 1
        ElseIf RadioButton13.Checked Or RadioButton15.Checked Then
        ...
        If RadioButton22.Checked Then
            ...
            zbir = zbir + 1
        ElseIf RadioButton24.Checked Or RadioButton23.Checked Then
        ...
        If RadioButton27.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton26.Checked Or RadioButton25.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton28.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton29.Checked Or RadioButton30.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton37.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton35.Checked Or RadioButton36.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton42.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton41.Checked Or RadioButton40.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton44.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton43.Checked Or RadioButton75.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton47.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton46.Checked Or RadioButton45.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton48.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton49.Checked Or RadioButton50.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton53.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton51.Checked Or RadioButton52.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton55.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton54.Checked Or RadioButton56.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton58.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton57.Checked Or RadioButton59.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton64.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton65.Checked Or RadioButton63.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton70.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton68.Checked Or RadioButton69.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton73.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton74.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton76.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton77.Checked Or RadioButton78.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If
        ...
        If RadioButton60.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
        ElseIf RadioButton79.Checked Or RadioButton80.Checked Then
            TextBox8.Text = "Netačan odgovor!"
        End If

        If RadioButton83.Checked Then
            TextBox8.Text = "Tačan odgovor!"
            zbir = zbir + 1
